define({
    ...
    customizeButtonLabel: '설치 사용자 지정',
    ...
    activationKeyContextHelp: '활성화 키는 MathWorks 계정을 라이선스에 연결합니다. 라이선스 관리자로부터 활성화 키를 받을 수 있습니다.',
    ...
    activationKeyButton: '활성화 키가 있습니다',
    ...
    prodAuthOnlineWorkflowButton: '라이선스를 선택합니다',
    prodAuthOfflineWorkflowButton: '라이선스 파일을 사용합니다',
    ...
    selectLicenseFileForToolTipHelpNetwork: '라이선스 관리자로부터 라이선스 파일을 받습니다',
    selectLicenseFileForToolTipHelpNonNetwork: 'MathWorks 라이선스 센터 또는 라이선스 관리자로부터 라이선스 파일을 받습니다',
    licenseManagerToolTipHelp: '이 설치 방법은 라이선스 관리자만 이용 가능합니다. Concurrent License와 Network Named User License를 사용하려면 서버에 네트워크 라이선스 매니저를 설치해야 합니다.',
    akLabel: '활성화 키 입력',
    installationFolderLabel: '대상 폴더 선택',
    downloadFolderLabel: '대상 폴더 선택',
    matlabRuntimeFolderLabel: '설치 폴더 선택',
    ...
    personalizedSymbolicLinkLabel: '${0}에 MATLAB 스크립트의 기호화된 링크 만들기',
    userExperienceLabel: '더 개선된 MATLAB이 나올 수 있도록 사용자 경험 정보를 MathWorks로 전송',
    improveMATLABLabel: '더 개선된 MATLAB이 나올 수 있도록 사용자 경험 정보를 MathWorks로 전송합니다.',
    finalLabel: '설치 완료',
    ...
    optionalLicenseSelectionTitle: '라이선스 파일 선택(선택 사항)',
    optionalLicenseSelectionFolderLabel: '라이선스 파일의 전체 경로를 파일 이름을 포함하여 입력',
    ...
    activationModeAuthRadioText: '소프트웨어를 실행하려면 인터넷 연결이 필요함',
    ...
    provideUserInfoText: '한 사람만 이 라이선스를 사용할 수 있습니다. 라이선스 최종 사용자를 지정하십시오:',
    provideUserInfo: '(필요한 경우 이 사용자의 MathWorks 계정이 만들어짐)',
    productDependecyDialogTitle: '제품 종속 항목',
    ...
    studentConfirmMessage: '이것은 Student License입니다. 귀하는 학위를 수여하는 고등 교육 기관에 재학 중인 학생이거나 고등학교/예비 대학의 학생 또는 교사여야 합니다. 이 라이선스는 상업적인 용도나 다른 용도로는 사용할 수 없습니다. MathWorks는 학생을 위한 특별 서비스로 이 라이선스를 제공하는 것이며, 라이선스가 남용되지 않도록 주의해 줄 것을 부탁드립니다.\n\n귀하는 학습 과제에 이 소프트웨어를 사용하는 학교, 대학 또는 대학교의 학생입니까?\n\n',
    yes: '예',
    no: '아니요',
    userNameModifyTitle: 'Windows 사용자 이름 경고',
    userNameModifyMessage1: '소프트웨어가 다음과 다른 사용자 이름으로 실행될 경우에만 변경: ${0}',
    userNameModifyMessage2: ' <br> <br>사용자 이름에 대한 자세한 내용은 이 <a href="https://www.mathworks.com/pi_unc_mpi_${0}_${1}" target="_blank">MATLAB Answer</a>를 참조하십시오.',
    loginNameModifyTitle: '로그인 이름 경고',
    loginNameModifyMessage1: '소프트웨어가 다음과 다른 로그인 이름으로 실행될 경우에만 변경: ${0}',
    loginNameModifyMessage2: '<br> <br>로그인 이름에 대한 자세한 내용은 이 <a href="https://www.mathworks.com/pi_unc_mpi_${0}_${1}" target="_blank">MATLAB Answer</a>를 참조하십시오',
    userNameRequired: '사용자 이름이 필요함',
    confirmationDialogTitle: '취소 확인',
    confirmationDialogText: '지금 중지하면 설치를 처음부터 다시 시작해야 합니다.<br><br>지금 중지하시겠습니까?',
    confirmationDialogProdAuthText: '종료하시겠습니까?',
    ...
    connectionErrorMsg: '애플리케이션을 MathWorks에 연결할 수 없습니다.<br>이 문제를 해결하려면 <a href="https://www.mathworks.com/pi_dlerr_mpi " target="_blank">고객 지원팀</a>에 문의하십시오',
    ...
    installationNotesTitle: '<b>설치된 제품에 추가적인 구성 단계가 필요할 수 있습니다.</b><br><br>',
    userAppFolderConfirmationTitle: '${0} 대상 폴더',
    runtimeConfirmationTitle: 'MATLAB Runtime 대상 폴더',
    ...
    noArchiveErrorMsg: '설치할 제품 파일을 찾을 수 없습니다. 도움이 필요하면 <a href="https://www.mathworks.com/pi_miferr_mpi " target="_blank">MATLAB Answer</a>를 참조하십시오.',
    noArchiveErrorTitle: '설치 파일이 누락됨',
    noInternetNoArchiveErrorMsg1: '문제는 다음 중 하나일 수 있습니다:',
    noInternetNoArchiveErrorMsg2: '<li>인스톨러가 MathWorks에 연결할 수 없습니다. 이는 방화벽 또는 바이러스 백신 소프트웨어로 인한 것일 수 있습니다.  자세한 내용은 <a href="https://www.mathworks.com/pi_icerr_mpi " target="_blank">MATLAB Answer</a>를 참조하십시오.</li>',
    noInternetNoArchiveErrorMsg3: '<li>오프라인 설치에 필요한 제품 파일이 누락되었습니다. 자세한 내용은 <a href="https://www.mathworks.com/pi_miferr_mpi " target="_blank">MATLAB Answer</a>를 참조하십시오.</li>',
    documentationInstructionMsg: '<br>문서는 기본적으로 온라인에서 사용 가능합니다. 오프라인으로 사용하는 경우 로컬 복사본을 설치하십시오.<br><a href="https://www.mathworks.com/pi_doconline_mpi_${0}_${1}" target="_blank">자세히 알아보기</a>',
    noInternetNoArchiveErrorTitle: '계속할 수 없음',
    activateButtonLabel: '활성화',
    finalLabelProductAuthorizer: '활성화 완료',
    actionRequired: '필요한 조치:',
    missingJREText: '이 MATLAB 버전에는 Java Runtime이 필요합니다. <a href="https://www.mathworks.com/pi_mpi_macajre_${0}_${1}" target="_blank">Java Runtime 설치</a>',
    missingJRETextRuntime: '이 애플리케이션에는 Java Runtime이 필요합니다. <a href="https://www.mathworks.com/pi_mri_macajre_${0}_${1}" target="_blank">Java Runtime 설치</a>',
    startMATLABLabel: 'MATLAB 시작',
    personalizedPanelTitle: '설치 준비 완료',
    productHeader: '제품',
    installFolderHeader: '대상 폴더',
    infoPopOver: 'MATLAB 내의 애드온 측면 패널에서 추가 제품을 얻을 수 있습니다.',
    licenseCenterText: '라이선스에 포함된 제품에 대한 자세한 내용을 보려면 <a href="https://www.mathworks.com/pi_lc_mpi_${0}_${1}" target="_blank">라이선스 센터</a>에 접속하십시오.'
});
